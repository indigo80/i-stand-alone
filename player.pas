...
type
  ...
  public
    sprite, crosshair, healthBar, bullet: zglCSprite2D;
    health:Single;
    weight: Single;
    speed: Single;
    stamina: Single;
...
begin
  ...
  sprite.Texture:=TResources.playerTexture;
  crosshair.Texture:=TResources.crosshairTexture;
  bullet.Texture:=TResources.bulletTexture;
